                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-icon flex-style">
                                        <ul>
                                            ...
                                            <li><a href="wishlist.html"><i class="fa fa-heart"></i></a></li>
                                            <li><a data-toggle="modal" data-target="#exampleModalCenter{{ $latest_product->id }}" href="javascript:void(0);"><i class="fa fa-shopping-bag"></i></a></li>
                                        ...
                                        <div class="modal-body d-flex">
                                            ...
                                            <div class="product-single-content w-50">
                                                ...
                                                <div class="rating-wrap fix">
                                                    <span class="pull-left priceOfSize">${{ $latest_product->product_price }}</span>
                                                ...
                                                <form action="{{ route('productCartFromModel') }}" method="POST">
                                                    ...
                                                    <ul class="color">
                                                        @php
                                                            $productAttri = App\Models\ProductAttribute::with(['Color'])->where('product_id', $latest_product->id)->get();
                                                        ...
                                                        @foreach ( $groupby as $item)
                                                            <input type="radio" name="color_id" data-product="{{ $latest_product->id }}" class="color_id" id="color_id{{ $item[0]->id }}" value="{{ $item[0]->color_id }}"><label for="color_id{{ $item[0]->id }}">{{ $item[0]->Color->color_name }}</label>
                                                        @endforeach
                                                    </ul>
                                                    ...
                                                    <ul class="availablequantity">
                                                        <li>
                                                            <span class="availableQuantity text-success">{{ 'Total Available Quanity: '.$latest_product->ProductAttribute->sum('quantity') }}</span>
                                                        </li>
                                                    </ul>

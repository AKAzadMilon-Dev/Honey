            ...
            <div class="row">
                <div class="col-lg-9 col-12">
                    <div class="blog-details-wrap">
                        <img src="{{ asset('featured/'.$singleBlogs->created_at->format('Y/m/').$singleBlogs->id.'/'.$singleBlogs->featured_image) }}" alt="">
                        <h3>{{ $singleBlogs->title }}</h3>
                        <ul class="meta">
                            <li>{{ $singleBlogs->created_at->format('d m Y') }}</li>
                            <li>{{ $singleBlogs->User->name }}</li>
                        </ul>
                        {!! $singleBlogs->summary !!}
                        ...
                        <div class="widget widget_recent_entries recent_post">
                            ...
                            <ul>
                                @foreach ($blogs as $blog)
                                    <li>
                                        <div class="post-img">
                                            <img width="50" src="{{ asset('thumbnail/'.$blog->created_at->format('Y/m/').$blog->id.'/'.$blog->thumbnail) }}" alt="">
                                        </div>

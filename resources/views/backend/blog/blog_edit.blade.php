            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item"><a href="{{ url('admin/category-list') }}">Blog-list</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-md-8 m-auto">
                        <div class="card-box">
                            <h4 class="m-t-0 m-b-30 header-title text-center">Edit Blog</h4>
                            <div class="text-center">
                                <a href="{{ url('admin/category-list') }}" class="btn btn-outline-primary"> <i
                                        class="fi-menu"></i> View Blog</a>
                            </div>
                                    ...
                                    <div class="row mg-b-25">
                                        <div class="col-lg-12">
                                            <div class="form-group mg-b-10-force">
                                                ...
                                                <input type="text" name="title" class="form-control @error('title')is-invalid @enderror" id="title" placeholder="Ex: Web Design" value="{{ $blog->title ?? old('title') }}">
                                            </div>
                                            @error('title')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group mg-b-10-force">
                                                ...
                                                <input type="file" name="thumbnail" class="form-control @error('thumbnail')is-invalid @enderror" id="thumbnail" value="{{ old('thumbnail') }}" onchange="document.getElementById('thumbnail1').src = window.URL.createObjectURL(this.files[0])">
                                            </div>
                                            @error('thumbnail')
                                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                    <strong>{{ $message }}</strong>
                                            ...
                                            @enderror
                                            <img src="{{ asset('thumbnail/'.$blog->created_at->format('Y/m/').$blog->id.'/'.$blog->thumbnail) }}" id="thumbnail1" width="250" height="250"/>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mg-b-10-force">
                                                <label for="featured_image">Featured Image</label>
                                                <input type="file" name="featured_image" class="form-control @error('featured_image')is-invalid @enderror" id="featured_image" value="{{ old('featured_image') }}"  onchange="document.getElementById('featured_image1').src = window.URL.createObjectURL(this.files[0])">
                                            </div>
                                            ...
                                            @enderror
                                            <img src="{{ asset('featured/'.$blog->created_at->format('Y/m/').$blog->id.'/'.$blog->featured_image) }}" id="featured_image1" width="250" height="250"/>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group mg-b-10-force">

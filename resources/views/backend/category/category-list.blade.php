                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <div class="text-center">
                                <a href="{{ url('admin/category-add') }}" class="btn btn-outline-primary mb-3"> <i class="fi-plus"></i> Add Category</a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                <a href="{{ url('admin/category-edit') }}/{{ $item->id }}" class="btn btn-outline-primary rounded-5">Edit</a>
                                                <a href="{{ url('admin/category-delete') }}/{{ $item->id }}" class="btn btn-outline-danger rounded-5">Delete</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach

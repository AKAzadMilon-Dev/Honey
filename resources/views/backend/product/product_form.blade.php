                        ...
                        <div class="card-box">
                            ...
                            <form role="form" action="{{ route('ProductPost') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="productSummary" class="form-control @error('productSummary') is-invalid @enderror" id="productSummary">{{ old('productSummary') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="productDesc" class="form-control @error('productDesc') is-invalid @enderror" id="productDesc">{{ old('productDesc') }}</textarea>
                                    @error('productDesc')
                                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong>{{ $message }}</strong>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">

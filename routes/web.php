...
Route::get('single-blog/{slug}',[FrontendController::class, 'singleBlog'])->name('singleBlog');
...
Route::get('order/search', [DashboardController::class, 'OrderSearch'])->name('OrderSearch');
